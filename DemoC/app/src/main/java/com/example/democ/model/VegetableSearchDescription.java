...
public class VegetableSearchDescription implements Serializable {
    @SerializedName("no")
    private int stt;
    ...
    //CST search
    public VegetableSearchDescription(int stt, String idName, String idDescription, String idFeature, String idImage, String name, String description,
