...
public class SearchByDescriptionBottomSheetFragment extends BottomSheetDialogFragment {
    private ArrayList<VegetableData> mListVegetable;
    private IClickVegetable mIClickVegetable;

    public SearchByDescriptionBottomSheetFragment(ArrayList<VegetableData> mListVegetable, IClickVegetable mIClickVegetable) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_search_by_description_bottom_sheet, null);
        bottomSheetDialog.setContentView(view);
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_search_by_description_bottom_sheet);
