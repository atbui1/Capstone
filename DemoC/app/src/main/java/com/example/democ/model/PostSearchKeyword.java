...
public class PostSearchKeyword implements Serializable {
    @SerializedName("id")
    private String id;
    ...
    public PostSearchKeyword(String id, String vegName, String vegDescription, String vegFeature, int quantity, int type,
